...
import { CheckCircle, ChevronDown, ChevronUp, Car, User, Clock, Phone, Sparkles } from 'lucide-react'
...
export function EstimateClient({ estimate, token, shopProfile }: EstimateClientProps) {
  const interestOnly = shopProfile?.estimateMode === 'interest_only'
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-6">
        <div className="text-center max-w-md">
          ...
          <div className="bg-muted/50 rounded-xl p-6 text-left space-y-3">
            ...
            {!interestOnly && submitResult.approvedAmount > 0 && (
  ...
  return (
    <div className="min-h-screen bg-background pb-36">
        ...
        <div className="max-w-lg mx-auto px-4 pt-5">
          ...
          <div className="bg-card rounded-xl border border-border p-5 mb-5">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              {interestOnly
                ? 'recommended for your vehicle based on its maintenance schedule. Select the ones you\u2019re interested in and we\u2019ll follow up with details.'
                : 'that could use attention. You decide what makes sense for you right now. Tap any glowing area below to explore.'}
            </p>
          </div>

          {/* AI Disclaimer */}
          <div className="flex items-start gap-2.5 px-1 mb-5">
            <Sparkles className="w-4 h-4 text-muted-foreground/60 flex-shrink-0 mt-0.5" />
            <p className="text-xs text-muted-foreground/80 leading-relaxed">
              These recommendations were generated by our AI assistant based on your vehicle&apos;s
              manufacturer maintenance schedule and current mileage. It&apos;s pretty smart, but your
              service advisor is smarter &mdash; they&apos;ll confirm final recommendations and pricing
      ...
      {/* AI Disclaimer (when no vehicle diagram) */}
      {!(estimate.vehicleImagePath && estimate.hotspots && estimate.hotspots.length > 0) && (
        <div className="max-w-lg mx-auto px-4 pt-5">
        ...
        <div className="max-w-lg mx-auto px-4 py-4 space-y-3">
          ...
          >
            {submitting
              ...
              : selectedServices.size > 0
                ? interestOnly
                  ? `I'm Interested in ${selectedServices.size} Service${selectedServices.size > 1 ? 's' : ''}`
